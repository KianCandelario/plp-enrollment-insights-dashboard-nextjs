    ...
    <div className="relative w-full flex items-center justify-start">
      <div className="w-[60%] flex flex-col justify-center items-start text-white_ px-10 py-7 z-50">
        <div className="flex flex-col justify-center mb-5">
          ...
          >
            PLP's Enrollment <br /> Insights Dashboard
          </h1>
        </div>
        ...
        <div
          className="button w-40 h-12 bg-[#c6dec8] cursor-pointer select-none active:translate-y-2 active:[box-shadow:0_0px_0_0_#B7B597] active:border-b-[0px] 
                transition-all duration-150 [box-shadow:0_10px_0_0_#7c8b6f,0_15px_0_0_#94a684] rounded-full border [7px] border-[#94a684] drop-shadow-xl ease-in-out
        ...
        >
          <Link
            className={`${quicksand.className} flex justify-center items-center h-full text-[#444444] text-sm font-bold relative z-10`}
            href={"/login"}
          >
            <Image
              className="mr-2"
